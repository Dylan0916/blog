...
tags:
  ...
  - Inquirer
  - Nodejs
description: "用 Inquirer.js 打造 code generator，自動產生專案中重複的樣板檔案。"
...
在沒有 code-gen 前，都是找個需求類似的 reducer、epic 複製一下，但漏掉東西也是常有的事；第一代上線後直接省掉 70–80% 的時間。

第二代一開始去研究 shell，看不到幾分鐘就放棄了，關鍵字也下不對，找不到想要的套件，最後是在 FE weekly 上問了 team 才拿到 Inquirer。

弄完後新人接手加 API / reducer 也輕鬆許多，跟著 prompt 走就好，不會再漏東漏西。
