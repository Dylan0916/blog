...
最近突然意識到該重新有一個自己的網站，不然身為一個前端工程師，卻沒有自己的網站，總覺得怪怪的，且剛好近幾年有在 Medium 寫一些文，若再晚決定，搬的成本會增加，而我也可以順便練習 SEO。就在這念頭下，我決定開始研究要用哪套框架來做。
...
整體來說，這次搬家算滿意，挺花時間但能學到不少。剩下幾件事還沒處理：google search console 的 site map 不知為何一直驗證不到、留言系統得自己做，目前 Medium 那邊仍會再同步更新文章 (這邊寫完再複製過去)。
